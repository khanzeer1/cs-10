...
public class Assignment5 
{
	...
	{
		int num1 = 79 + 3 * (4 + 82 - 68) - 7 +19;//gives the calculation a variable

		int num2 = (179 +21 +10) / 7 + 181;//gives the calculation a variable

		int num3 = 10389 * 56 * 11 + 2246;//gives the calculation a variable
